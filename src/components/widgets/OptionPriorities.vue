<template>
  <div class="priorities__wrapper">
    <div
        ...
        :class="{priority: true, selected: isSelected(priority)}"
    >
  ...
  <div class="set-priority__btns">
    <button
        class="set-priority__btn cancel-btn"
        @click="cancelPriorities($store.state.Options)"
    >Cancel
    </button>
    <button
        class="set-priority__btn save-priority__btn"
        @click="savePriority($store.state.Options)"
    >Save
    </button>
  </div>
</template>
...
export default {
  methods: {
    ...mapMutations({
      selectPriority: 'Options/OptionPriorities/selectPriority',
      savePriority: 'Options/OptionPriorities/savePriority',
      cancelPriorities: 'Options/OptionPriorities/cancelPriorities',
    })
  },
  computed: {
    ...mapState({
      priority: state => state.Options.OptionPriorities.priority,
    }),
    ...mapGetters('Options/OptionPriorities', [
      'isSelected',
    ])
  }
}
